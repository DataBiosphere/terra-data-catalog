...
COMMON_VAULT_PATH="secret/dsde/terra/kernel/perf/common"
...
$VAULT_COMMAND -field=key "$COMMON_VAULT_PATH/testrunner/testrunner-sa" | base64 -d > "$INTEGRATION_OUTPUT_LOCATION/testrunner-perf.json"
