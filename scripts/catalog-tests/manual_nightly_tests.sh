...
# script for manually triggering nightly-tests.yml github workflow
...
curl -H "Authorization: token $(cat ~/.gh_token)" \
  ...
  https://api.github.com/repos/DataBiosphere/terra-data-catalog/actions/workflows/nightly-tests.yml/dispatches
